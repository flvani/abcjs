...
copy /b/y css\perfect-scrollbar.css+css\menu-group.css+css\dropdown-menu.css+css\tabbed-view.css+css\draggable.css tmp\styles4abcx.css
...
copy /b/y jslib\perfect-scrollbar.js+draggable\draggable.js+draggable\dropdown.js+draggable\dialogs.js tmp\abcjs-windows.js
