...
SVG.Glyphs = function () {
    ...
    var glyphs = {
      "1": '<path id="1" class="fill" \nd="@@"/>',
      "2": '<path id="2" class="fill" \nd="@@"/>',
      "3": '<path id="3" class="fill" \nd="@@"/>',
      "4": '<path id="4" class="fill" \nd="@@"/>',
      "5": '<path id="5" class="fill" \nd="@@"/>',
      "6": '<path id="6" class="fill" \nd="@@"/>',
      "7": '<path id="7" class="fill" \nd="@@"/>',
      "8": '<path id="8" class="fill" \nd="@@"/>',
      "9": '<path id="9" class="fill" \nd="@@"/>',
      "clefs.G": '<path id="clefs.G" class="fill" \nd="@@"/>',
      "clefs.F": '<path id="clefs.F" class="fill" \nd="@@"/>',
      "clefs.C": '<path id="clefs.C" class="fill" \nd="@@"/>',
      "clefs.tab": '<path id="clefs.tab" class="fill" \nd="@@"/>',
      "timesig.common": '<path id="timesig.common" class="fill" \nd="@@"/>',
