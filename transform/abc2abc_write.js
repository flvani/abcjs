...
if (!window.ABCXJS.transform)
	window.ABCXJS.transform = {};


window.ABCXJS.transform.TextPrinter = function(elem, reposition) {
    this.elem = elem;
    this.text = "";
    this.l = 1/8;
...
window.ABCXJS.transform.TextPrinter.prototype.printString = function(str, elem) {
    if (this.reposition && elem) elem.startChar = this.text.length;
    this.text += str;
    if (this.reposition && elem) elem.endChar = this.text.length;
};

window.ABCXJS.transform.TextPrinter.prototype.printNewLine = function () {
    this.text += "\n";
};

window.ABCXJS.transform.TextPrinter.prototype.printSpace = function () {
    if (this.text[this.text.length-1].match(/\s/)) return; //TODO match whitespace
    this.text += " ";
};

window.ABCXJS.transform.TextPrinter.prototype.printABC = function(abctune) {
    this.text = "";
...
window.ABCXJS.transform.TextPrinter.prototype.printHeader = function() {
...
window.ABCXJS.transform.TextPrinter.prototype.getKeyString = function(key) {
    return key.root+key.acc+key.mode;
};

window.ABCXJS.transform.TextPrinter.prototype.getMeterString = function(meter) {
    switch (meter.type) {
...
window.ABCXJS.transform.TextPrinter.prototype.printHeaderLine = function(fieldname, abcfield, defaut) {
...
window.ABCXJS.transform.TextPrinter.prototype.getElem = function() {
    if (this.abcline.length <= this.pos)
	return null;
    return this.abcline[this.pos];
};

window.ABCXJS.transform.TextPrinter.prototype.getNextElem = function() {
    if (this.abcline.length <= this.pos+1)
	return null;
    return this.abcline[this.pos+1];
};

window.ABCXJS.transform.TextPrinter.prototype.printBody = function() {
...
window.ABCXJS.transform.TextPrinter.prototype.printABCLine = function(staffs) {
    for (this.s = 0; this.s < staffs.length; this.s++) {
	this.printABCStaff(staffs[this.s]);
    }
};

window.ABCXJS.transform.TextPrinter.prototype.printABCStaff = function(abcstaff) {
...
window.ABCXJS.transform.TextPrinter.prototype.printABCVoice = function(abcline) {
...
window.ABCXJS.transform.TextPrinter.prototype.printABCElement = function() {
...
window.ABCXJS.transform.TextPrinter.prototype.printBeam = function() {
    this.printSpace();
...
window.ABCXJS.transform.TextPrinter.prototype.printNote = function(elem) {
    var str = "";
	var i;
...
window.ABCXJS.transform.TextPrinter.prototype.getNoteString = function(pitchelem, ignoreslur) {
    var str = "";
...
window.ABCXJS.transform.TextPrinter.prototype.getDurationString = function(duration) {
...
window.ABCXJS.transform.TextPrinter.prototype.extractNote = function(pitch) {
    var pitch2 = pitch%7;
    if (pitch2<0) pitch2+=7;
    return pitch2;
};

window.ABCXJS.transform.TextPrinter.prototype.extractOctave = function(pitch) {
    return Math.floor(pitch/7);
};

window.ABCXJS.transform.TextPrinter.prototype.printBarLine = function(elem) {
    var barstr = "";
    switch (elem.type) {
...
window.ABCXJS.transform.TextPrinter.prototype.multiplyString = function (s, n) {
    var ret = "";
    for (;n>0;n--) ret+=s;
    return ret;
};